...
from language_model.service.language_model_sevice import LanguageModelService
...
class LanguageModelServiceImpl(LanguageModelService):
    ...
    def predictWithModelingLanguage(self, userRequestForm):
        ...
        # TODO: 임시 방편 <- 추후 charToINdex의 경우 벡터 DB등을 사용하여 관리해야 함
        ...
        generatedText = self.__languageModelRepository.generateText(loadedShakespeareModel, inputTensor, indexToChar)
