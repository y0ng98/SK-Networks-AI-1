...
from language_model.service.language_model_sevice_impl import LanguageModelServiceImpl
...
async def operateLanguageModel(languageModelService: LanguageModelServiceImpl =
    ...
    # return JSONResponse(content=languageModel, status_code=status.HTTP_200_OK)
